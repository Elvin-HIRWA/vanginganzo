...
<section class="hero-area">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                                ...
                                <h2 data-animation="fadeInUp" data-delay="300ms">Vangainganzo <span>Vangainganzo</span></h2>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                    <div class="single-album-area wow fadeInUp" data-wow-delay="100ms">
                        <div class="album-thumb">
                            <img src="../../public/assets/img/bg-img/b1.jpg" alt="">
                            <!-- Album Price -->
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                    <div class="single-album-area wow fadeInUp" data-wow-delay="200ms">
                        <div class="album-thumb">
                            <img src="../../public/assets/img/bg-img/b2.jpg" alt="">
                        </div>
                        <div class="album-info">
                            <a href="#">
                                <h5>Noises</h5>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                    <div class="single-album-area wow fadeInUp" data-wow-delay="300ms">
                        <div class="album-thumb">
                            <img src="../../public/assets/img/bg-img/b3.jpg" alt="">
                        </div>
                        <div class="album-info">
                            <a href="#">
                                <h5>Jess Parker</h5>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                    <div class="single-album-area wow fadeInUp" data-wow-delay="400ms">
                        <div class="album-thumb">
                            <img src="../../public/assets/img/bg-img/b4.jpg" alt="">
                        </div>
                        <div class="album-info">
                            <a href="#">
                                <h5>Noises</h5>
    ...
    <section class="featured-artist-area section-padding-100 bg-img bg-overlay bg-fixed" id="features">
        <div class="container">
